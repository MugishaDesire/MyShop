  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        // Navigate FIRST, then call onLogin
        if (pendingRedirect === "checkout" && pendingCart.length > 0) {
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .back-home-link { display: flex; align-items: center; gap: 0.5rem; text-decoration: none; color: white; font-weight: 600; padding: 0.75rem 1.5rem; border-radius: 50px; background: linear-gradient(135deg, #4f5867 0%, #dce1ec 100%); box-shadow: 0 4px 15px rgba(59,130,246,0.3); transition: all 0.3s ease; }
        .back-home-link:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(37, 40, 44, 0.4); }
        ...
        .login-card { display: flex; max-width: 1000px; width: 100%; background: white; border-radius: 20px; box-shadow: 0 20px 40px -12px rgba(0,0,0,0.2); overflow: hidden; transition: all 0.3s ease; }
        ...
        .info-message { background: #dbeafe; color: #3754b6; padding: 0.75rem 1rem; border-radius: 8px; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; animation: slideIn 0.3s ease; }
        .error-message { background: #fee2e2; color: #dc2626; padding: 0.75rem 1rem; border-radius: 8px; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; animation: slideIn 0.3s ease; }
        ...
        .circle { position: absolute; width: 150px; height: 150px; background: rgba(255,255,255,0.1); border-radius: 50%; top: 20px; left: 25px; animation: float 6s ease-in-out infinite; }
        .dots { position: absolute; width: 100%; height: 100%; background-image: radial-gradient(rgba(255,255,255,0.2) 2px, transparent 2px); background-size: 20px 20px; animation: move 10s linear infinite; }
        ...
        .input-wrapper input { width: 100%; padding: 0.85rem 1rem 0.85rem 2.8rem; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 0.95rem; transition: all 0.3s ease; outline: none; }
        ...
        .signin-btn { width: 100%; padding: 0.9rem; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; border: none; border-radius: 12px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 4px 6px rgba(59,130,246,0.2); display: flex; align-items: center; justify-content: center; gap: 0.5rem; }
        ...
        .social-login-btn { width: 100%; padding: 0.85rem; background: white; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 0.95rem; font-weight: 500; color: #475569; display: flex; align-items: center; justify-content: center; gap: 0.75rem; cursor: pointer; transition: all 0.2s ease; }
        ...
        .guest-link { display: inline-flex; align-items: center; gap: 0.5rem; color: #64748b; text-decoration: none; font-size: 0.95rem; transition: all 0.2s ease; padding: 0.5rem 1rem; border-radius: 50px; background: #f8fafc; }
